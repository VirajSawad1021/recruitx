        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            {authLoading ? null : user ? (
              <>
                <Link
                  href={profile?.role === "recruiter" ? "/dashboard/recruiter" : "/dashboard/candidate"}
                  className="rounded-lg bg-foreground px-4 py-2 text-sm font-semibold text-white hover:bg-foreground/90 transition-all shadow-sm"
                >
                  Dashboard
                </Link>
